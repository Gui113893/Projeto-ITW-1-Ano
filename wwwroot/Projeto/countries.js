...
var vm = function () {
    ...
    self.activate = function (id) {
        ...
        $('#search-button').click(function() {
            ...
            if (query.length == 0){
                ...
                $.ajax({
                    url: `http://192.168.160.58/Olympics/api/countries/SearchByName?q=${query}`,
                    success: function(data) {
    ...
    self.showCountryDetails = function(country) {
        ajaxHelper(`http://192.168.160.58/Olympics/api/countries/${country.Id}`, "GET").done(function(data){
            self.selectedCountry(data);

            data.Events.forEach(function(record) {
